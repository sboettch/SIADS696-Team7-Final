...
FIG = "../outputs/reproducible_report_figures"
OUT = ROOT / "notebooks" / "SIADS_696_Team_7_Final_Report.ipynb"
...
cells = [
    md(
        ...
        **Report format note.** This notebook is written as the final report artifact. All report figures are loaded from `outputs/reproducible_report_figures/`, which is regenerated by `notebooks/Final_Report_Reproducible_Visualizations.ipynb` from project data and model-output CSVs.
        """
    ),
    md(
        """
    ...
    md(
        f"""
        ![Figure 11. DBSCAN and K-Means unsupervised sensitivity search.]({FIG}/figure_11_unsupervised_parameter_search.png)
        """
    ),
    md(
        """
    ...
    md(
        ...
        **Answer:** Yes. The figures in this notebook are loaded from `outputs/reproducible_report_figures/`, and that folder is regenerated by `notebooks/Final_Report_Reproducible_Visualizations.ipynb` using repository data and model-output CSVs. The figure manifest is `outputs/reproducible_report_figures/figure_manifest.csv`.
        """
    ),
]
